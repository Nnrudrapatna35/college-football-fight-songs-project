...
From the univariate summary statistics and visualization (histogram) in the exploratory data analysis section, we learned, in the majority of college fight songs, the word "fight" appears only a few times. Moreover, the bivariate summary statistics and visualization (boxplots) revealed that the frequency of "fight" in fight songs is dependent on the particular conference a college belongs to. For instance, Louisiana State University, or LSU as it appears in the `fight_songs` dataset, is a member of the SEC conference. Thus, LSU is predicted to have a relatively large number of occurrences of "fight" in its fight song since SEC has the second highest median occurrences of this word amongst the conferences considered. 
